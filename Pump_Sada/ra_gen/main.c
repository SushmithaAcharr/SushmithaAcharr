...
extern void config_thread0_create(void);
extern TaskHandle_t config_thread0;
extern void fan_control_thread_create(void);
extern TaskHandle_t fan_control_thread;
extern void modbus_thread_create(void);
extern TaskHandle_t modbus_thread;
...
int main(void)
{
    ...
    config_thread0_create ();
    fan_control_thread_create ();
